...
test("rescue command absorbs continue semantics", () => {
  ...
  assert.match(agent, /If the user asks for a concrete model name such as `gpt-5\.5-mini`, pass it through with `--model`/i);
  ...
  assert.match(readme, /--model gpt-5\.5-mini --effort medium/i);
